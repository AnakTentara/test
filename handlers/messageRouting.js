...
const { activeChats, disabledChats, saveSingleShakaruMemory, saveActiveChats, deleteMemory, saveDisabledChats, chatMemories, haikaruMemories, aiSentMessageIds, addChatLog } = require('./dbHandler');
